...
export default async function NewEncounterPage({ params }: PageProps) {
  ...
  return (
    <main className="space-y-6">
      ...
      <form action={createEncounter} className="max-w-4xl space-y-6 rounded-xl border p-6">
        ...
        <div className="space-y-2">
          ...
          <Input name="chief_complaint" placeholder="Headache, fever, routine follow-up..." />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Textarea name="assessment_notes" placeholder="Assessment findings..." />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Textarea name="plan_notes" placeholder="Treatment plan, follow-up instructions..." />
        </div>
